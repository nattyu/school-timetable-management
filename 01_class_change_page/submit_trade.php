...
if (!empty($_POST["class-select_1"]) && !empty($_POST["day-select_1"]) && !empty($_POST["time-select_1"])) {
   $selected_class = $_POST["class-select_1"];
   $selected_date = $_POST["day-select_1"];
   $selected_day = $result_day[date('N', strtotime($selected_date)) - 1][0];
   $selected_time = $_POST["time-select_1"];
